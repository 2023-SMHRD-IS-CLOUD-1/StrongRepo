	...
	<div class="custom-breadcrumns border-bottom">
		<div class="container">
			<a href="Gomain.do">Main</a> <span
				class="mx-3 icon-keyboard_arrow_right"></span> <span class="current">게시판</span>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="board_wrap">
				...
				<div class="board_view_wrap">
					...
					<div class="bt_wrap">
						<a href="Goknowledge_Board.do#board" class="on">목록</a> <a
							class="on">수정</a>
					</div>
				</div>
			</div>
	...
	<div class="comment_section">
		<div class="container">
			<div class="board_wrap">
				...
				<div class="board_list_wrap">
					<div class="cmt_board_list">
						<div
							...
							<div class="title">댓글이 없습니다. 작성해주시기 바랍니다.</div>
							<br>
					...
					<C:if test="${result==null}">
						<div class="cmt_title">
							<ul>
								<dd>
									<input type="text" disabled="disabled" name="comment"
										placeholder="로그인 시 이용 가능합니다."
										style="width: 100%; height: 50px;">
								</dd>
							</ul>
						</div>
				...
				<div class="bt_wrap">
					<input type="hidden" class="postNumber" name="postNumber">
					<input type="submit" disabled="disabled" value="등록"
						class="btn btn-primary btn-lg px-5">
				</div>
			</div>
			</C:if>
