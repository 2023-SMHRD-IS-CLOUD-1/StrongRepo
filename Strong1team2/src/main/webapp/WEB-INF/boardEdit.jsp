...
<body data-spy="scroll" data-target=".site-navbar-target"
			...
			<div class="board_wrap">
				...
				<div class="board_write_wrap">
					...
					<div class="bt_wrap">
						...
						<form id="deleteForm" action="DropView.do" method="post"
							style="display: inline-block; margin-right: 10px; margin-left: 10px;">
							<input type="hidden" class="postNumber" name="postNumber">
							<input type="submit" value="삭제"
								class="btn btn-primary btn-lg px-5">
						</form>
						<input type="button" value="취소" onclick="goToAnotherPage()"
							class="btn btn-primary btn-lg px-5">
					</div>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		var post = document
				.querySelector("body > div.site-wrap > div.comment_site-section > div > div > div > div.board_view > div.info > dl:nth-child(1) > dd");
		var B_NUM = postId;
		...
		$.ajax({
					...
					success : function(result) {
						...
						const boardTitle = document
								.querySelector(`body > div:nth-child(5) > div > div > div.board_write_wrap > div.board_write > div.title > dl > dd`);
